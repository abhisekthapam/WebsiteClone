<template>
    <div class="main-container">
        <div class="main-div-one">
            <h1 class="the-feature-four-head">{{ h1 }}<br><span class="the-feature-four-span">{{ h2 }}</span></h1>
            <p class="the-feature-four-ptext">{{ p }}</p>
        </div>
            ...
            <div>
                <div class="text-container" :class="{ 'details-shown': showDetails }">
                    <h1 class="head-text" :style="{ color: showDetails ? '#29bf12' : '#223843' }">
                        {{ headText }}
                        <i class="fa-sharp fa-solid fa-plus" @click="showDetails = true;" v-show="!showDetails"></i>
                ...
                <div>
                    <div class="text-container1" :class="{ 'details-shown': showDetails1 }">
                        <h1 class="head-text" :style="{ color: showDetails1 ? '#29bf12' : '#223843' }">
                            {{ headText1 }}
                            <i class="fa-sharp fa-solid fa-plus icon1" @click=" showDetails1 = true;"
            ...
            <div>
                <div class="text-container2" :class="{ 'details-shown': showDetails2 }">
                    <h1 class="head-text" :style="{ color: showDetails2 ? '#29bf12' : '#223843' }">
                        {{ headText2 }}
                        <i class="fa-sharp fa-solid fa-plus icon2" @click=" showDetails2 = true;"
                            v-show="!showDetails2"></i>
...
export default {
    ...
    data() {
        return {
            headText: "Better Onboarding",
            headP:
                "Exceptional onboarding and customer support from a team dedicated to your firm’s success.",
            showDetails: true,
            headText1: "Intuitive Integrations",
            headP1:
                "Instantly connect, expand and sync your tools and knowledge with LeanLaw integrations.",
            showDetails1: false,
            headText2: "Product Tutorials",
            headP2:
                "Gain a deeper understanding of how LeanLaw can bring your firm to the next level.",
            showDetails2: false,

            h1: "More access",
            h2: "at the best value",
            p: "Adding LeanLaw to your legal lineup ensures the best functionality, support and integrations at the best value."
        };
    },
    mounted() {
...
.the-feature-four-span {
    color: #29BF12;
}

.the-feature-four-ptext {
    font-family: "Open Sans", sans-serif;
    font-weight: 400;
    font-size: 18px;
    line-height: 1.63;
